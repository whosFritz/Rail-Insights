...
public class ImpressumPage extends VerticalLayout {
    ...
    public ImpressumPage() {
        ...
        impressum.add(
                new H1("Impressum"),
                new Paragraph("Angaben gemäß § 5 TMG"),
                ...
                new Text(
                        """ 
                                        Impressum vom https://www.impressum-generator.de Impressum Generator der https://www.kanzlei-hasselbach.de/ Kanzlei Hasselbach, Rechtsanwälte für Arbeitsrecht und Familienrecht.
                                """));
        add(impressum);
    }
}
